...
class login_with_number extends StatelessWidget {
  login_with_number({
    Key? key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Align(
            alignment: Alignment(0.538, 0.24),
            child: SizedBox(
              width: 23.0,
              height: 24.0,
              child: Stack(
          ...
          Align(
            alignment: Alignment(-0.54, 0.044),
            child: SizedBox(
              width: 30.0,
              height: 20.0,
              child: Stack(
          ...
          Pinned.fromPins(
            ...
            child: Stack(
              children: <Widget>[
                ...
                Align(
                  alignment: Alignment(0.639, 0.02),
                  child: SizedBox(
                    width: 40.0,
                    height: 19.0,
                    child: PageLink(
