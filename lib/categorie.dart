...
import './categorie_grid_case.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          Pinned.fromPins(
            Pin(size: 407.0, middle: 0.5217),
            Pin(size: 667.0, end: 94.0),
            child: SingleChildScrollView(
              ...
              child: SizedBox(
                ...
                child: Stack(
                  children: <Widget>[
                    Pinned.fromPins(
                      Pin(size: 200.0, start: 2.0),
                      Pin(size: 120.0, middle: 0.7678),
                      child: categorie_grid_case(),
                    ),
                    Pinned.fromPins(
                      Pin(size: 200.0, start: 2.0),
                      Pin(size: 120.0, middle: 0.5119),
                      child: categorie_grid_case(),
                    ),
                    Align(
                      alignment: Alignment(1.0, 0.024),
                      child: SizedBox(
                        width: 200.0,
                        height: 120.0,
                        child: categorie_grid_case(),
                    ...
                    Pinned.fromPins(
                      Pin(size: 200.0, start: 2.0),
                      Pin(size: 120.0, middle: 0.2559),
                      child: categorie_grid_case(),
                    ),
                    Align(
                      alignment: Alignment(1.0, -0.488),
                      child: SizedBox(
                        width: 200.0,
                        height: 120.0,
                        child: categorie_grid_case(),
...
const String _svg_jzr859 =
    '<svg viewBox="4.5 4.5 10.5 10.5" ><path  d="M 4.5 4.5 L 15 4.5 L 15 15 L 4.5 15 L 4.5 4.5 Z" fill="none" stroke="#33cccc" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" /></svg>';
const String _svg_v58s0t =
    '<svg viewBox="21.0 4.5 10.5 10.5" ><path  d="M 21 4.5 L 31.5 4.5 L 31.5 15 L 21 15 L 21 4.5 Z" fill="none" stroke="#33cccc" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" /></svg>';
const String _svg_q7c79b =
    '<svg viewBox="21.0 21.0 10.5 10.5" ><path  d="M 21 21 L 31.5 21 L 31.5 31.5 L 21 31.5 L 21 21 Z" fill="none" stroke="#33cccc" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" /></svg>';
const String _svg_pnlu8j =
    '<svg viewBox="4.5 21.0 10.5 10.5" ><path  d="M 4.5 21 L 15 21 L 15 31.5 L 4.5 31.5 L 4.5 21 Z" fill="none" stroke="#33cccc" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" /></svg>';
